...
| Path | Purpose |
|:---|:---|
| [**logo.png**](logo.png) | The primary JSON project logo. |
...
Unless otherwise noted, all assets in this directory are original works created for the JSON project and are released under the same [MIT License](../LICENSE) as the source code.
