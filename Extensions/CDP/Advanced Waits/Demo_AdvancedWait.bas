...
Public Sub Demo_AdvancedWait()
    ...
    ' ========================================================
    br.printMsg info_, "▶ [1] DOM Mutation テストを開始します。", "Demo"
    ...
    If elem.isExist Then
        ...
        br.printMsg info_, "  - ✔️ 検知成功！ " & Format(Timer - startTime, "0.00") & "秒で変化を捉えました。", "Demo"
    End If
    ...
    ' ========================================================
    br.printMsg info_, "▶ [2] Network Idle テストを開始します。", "Demo"
    ...
    If elem.isExist Then
        ...
        br.printMsg info_, "  - ✔️ 検知成功！ " & Format(Timer - startTime, "0.00") & "秒で通信の終了(Idle)を確認しました。", "Demo"
    End If
