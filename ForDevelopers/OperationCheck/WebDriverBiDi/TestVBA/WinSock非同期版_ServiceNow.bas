Attribute VB_Name = "WinSock”ñ“¯Šú”Å_ServiceNow"
Option Explicit
...
'
' Entry point:
'   BiDi‚É‚æ‚é–`Œ¯‚ÌŽn‚Ü‚è_ServiceNow”ñ“¯Šú”Å
'
' Cancellation:
...
'***************************************************************************************************
Public Sub BiDi‚É‚æ‚é–`Œ¯‚ÌŽn‚Ü‚è_ServiceNow”ñ“¯Šú”Å()
    Const PROC As String = _
        "Demo_ServiceNow_Async.BiDi‚É‚æ‚é–`Œ¯‚ÌŽn‚Ü‚è_ServiceNow”ñ“¯Šú”Å"
