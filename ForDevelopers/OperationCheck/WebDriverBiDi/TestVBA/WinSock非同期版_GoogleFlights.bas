Attribute VB_Name = "WinSock”ñ“¯Šú”Å_GoogleFlights"
Option Explicit
...
'
' Entry point:
'   BiDi‚É‚æ‚é–`Œ¯‚ÌŽn‚Ü‚è_GoogleFlights”ñ“¯Šú”Å
'
' Cancellation:
...
'***************************************************************************************************
Public Sub BiDi‚É‚æ‚é–`Œ¯‚ÌŽn‚Ü‚è_GoogleFlights”ñ“¯Šú”Å()
    Const PROC As String = _
        "Demo_GoogleFlights_Async.BiDi‚É‚æ‚é–`Œ¯‚ÌŽn‚Ü‚è_GoogleFlights”ñ“¯Šú”Å"
